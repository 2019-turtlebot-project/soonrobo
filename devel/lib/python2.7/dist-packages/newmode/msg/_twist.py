...
"""autogenerated by genpy from newmode/twist.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['newmode/xyz','newmode/xyz']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.linear is None:
        self.linear = newmode.msg.xyz()
      if self.angular is None:
        self.angular = newmode.msg.xyz()
    else:
      self.linear = newmode.msg.xyz()
      self.angular = newmode.msg.xyz()
